        ...
        <main>
            <div class="flex flex-col md:flex-row justify-center gap-10 md:gap-0 ">
                ...
                <div class="w-full md:w-1/2 flex flex-col gap-5 ">
                    <div class="md:h-[400px] flex justify-center items-center">
                        <div
                            class="bg-gradient-to-r from-blue-400 to-indigo-500 w-[90%] mt-7 h-[96%] px-4 py-2 shadow-2xl rounded-lg">
                            <div class="flex flex-col item-center justify-center text-justify gap-3">
                                <h1
                                    class="text-white bg-gradient-to-r mt-3 from-teal-400 to-blue-500 text-center py-3 px-6 rounded-lg shadow-xl font-semibold text-xl md:text-xl">
                                    Layanan Magang (PKL) BBPPMPV BMTI</h1>
                                <p class="md:text-base text-sm text-white">Selamat datang di program Praktik Kerja
                                    Lapangan (PKL) di
                                    Balai
                                    Besar
                                    Pengembangan
                                ...
                                <p class="md:text-base text-sm text-white">PKL di BBPPMPV MTI adalah program magang
                                    untuk siswa SMK, mahasiswa D3, dan S1 yang ingin mendalami teknik mesin, elektro,
                                    dan teknologi industri. Peserta akan belajar langsung di lingkungan profesional
                                    dengan bimbingan ahli berpengalaman.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="flex flex-col md:flex-row justify-center mt-10 gap-5 md:gap-5">
                ...
                <div class="md:w-[50%] md:h-[400px] flex justify-center items-center focus:outline-none focus:ring-2">
                    <div
                        class="bg-gradient-to-r from-blue-600 to-teal-500 w-[90%] h-full px-4 py-6 shadow-2xl rounded-lg">
                        <div class="flex flex-col item-center justify-center text-justify gap-3">
                            <h1
                                class="text-white bg-gradient-to-r from-teal-400 to-blue-500 text-center py-3 px-6 rounded-lg shadow-xl font-semibold text-xl md:text-2xl">
                                Persyaratan Administrasi
                            </h1>
                            <ul
                                class="list-decimal md:mx-5 flex flex-col gap-4 mt-5 text-sm md:text-xl px-5 pb-10 text-white">
                ...
                <div class="md:w-[50%] md:h-[400px] flex justify-center items-center focus:outline-none focus:ring-2">
                    <div
                        class="bg-gradient-to-r from-indigo-600 to-teal-500 w-[90%] h-full px-4 py-6 shadow-2xl rounded-lg">
                        <div class="flex flex-col item-center justify-center text-justify gap-3">
                            <h1
                                class="text-white bg-gradient-to-r from-teal-400 to-indigo-500 text-center py-3 px-6 rounded-lg shadow-xl font-semibold text-xl">
                                Sistem, Mekanisme dan Prosedur Pekayaan
                            </h1>
                            <ul
                                class="list-decimal md:mx-5 flex flex-col gap-4 mt-5 text-sm md:text-xl px-5 pb-10 text-white">
                                <li>Sekolah/Universitas/ Perguruan tinggi mengajukan surat permohonan dan melampirkan
                                    proposal.</li>
                    ...
                    <div class="bg-gradient-to-r from-indigo-600 to-teal-500 w-[90%] px-4 py-6 shadow-2xl rounded-lg">
                        <div class="flex flex-col item-center justify-center text-justify gap-3">
                            ...
                            <ul
                                ...
                                <li>7 hari untuk penerbitan sertifikat (bila laporan sudah diterima oleh kepala unit
                                    tempat peserta magang)</li>
                ...
                <div class="md:w-[50%] md:h-[400px] flex justify-center items-center focus:outline-none focus:ring-2">
                    <div class="bg-gradient-to-r from-indigo-600 to-teal-500 w-[90%] px-4 py-6 shadow-2xl rounded-lg">
                        <div class="flex flex-col item-center justify-center text-justify gap-3">
                            ...
                            <h1
                                class="text-white mt-7 bg-gradient-to-r from-teal-400 to-indigo-500 text-center py-3 px-6 rounded-lg shadow-xl font-semibold text-xl">
                                Biaya
                            </h1>
            ...
            <div class=" w-full flex flex-col h-auto justify-center items-center" x-data="{ isOpen: false }">
                <div class="text-center md:py-10 pt-20 font-bold md:text-3xl text-2xl text-blue-500">
                ...
                <div class="flex flex-col justify-center pt-10 md:pt-0">
                    <button type="button"
                        ...
                        class="bg-gradient-to-r from-blue-500 to-teal-400  px-6 py-2 rounded-full hover:scale-110 focus:outline-none focus:ring-2 text-white font-bold tracking-wider animate-bounce"
                ...
                <div x-show="isOpen" id="form-pendaftaran" class="md:w-auto w-[90%] py-10">
                    <form action="{{ route('register.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="md:py-10 md:flex gap-5">
                            <!-- Biodata -->
                            <div
                                class="p-6 bg-gradient-to-r from-indigo-600 to-teal-500 rounded-lg shadow-inner mb-6 md:mb-0 md:w-[500px]">
                            ...
                            <div
                                class="p-6 bg-gradient-to-r from-teal-500 to-indigo-600 rounded-lg shadow-inner mb-6 md:mb-0 md:w-[500px]">

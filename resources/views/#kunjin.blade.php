            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-6">
                    <div
                        ...
                        <h4 class="bg-gradient-to-r font-bold from-yellow-600 to-orange-600 rounded-lg p-2 mb-4">Produk
                            Layanan</h4>
                    ...
                    <div
                        ...
                        <h4 class="bg-gradient-to-r font-bold from-indigo-600 to-blue-600 rounded-lg p-2 mb-4">Jangka
                            Waktu Pelayanan</h4>

...
@section('content')
    ...
    <div class="bg-blue-500 py-1 px-3 rounded-lg text-white ml-44 w-40">
        <a href="{{ route('showpancaniti.create') }}">Tambah Booking +</a>
    </div>
        ...
        <main class="w-full">
            ...
            <div class="w-full flex flex-col md:flex-row md:px-10 justify-center gap-6 ">
                ...
                <div class="w-full md:w-3/5 bg-gradient-to-r from-white-500 to-indigo-500 p-6 rounded-lg md:shadow-lg">
                    ...
                    <div class="w-2xl">
                        <img id="mainImage"
                            src="https://i2.wp.com/blog.tripcetera.com/id/wp-content/uploads/2020/10/Danau-Toba-edited.jpg"
                            alt="Foto Gedung" class="w-full h-[170px] md:h-[450px]  ">
                    </div>

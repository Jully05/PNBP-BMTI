...
@section('title', 'Admin | Edit Booking BINANGKIT')

@section('content')
    <div class="bg-primary py-3">
        <h3 class="text-white text-center">EDIT BOOKING GEDUNG BINANGKIT</h3>
    </div>

    <div class="container">
        <div class="row justify-content-center mt-4">
            <div class="col-md-10 d-flex justify-content-end">
                <a href="{{ route('showbinangkit.index') }}" class="btn btn-primary">List Booking</a>
            </div>
        </div>
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-10">
                <div class="card border-0 shadow-lg my-4">
                    ...
                    <form action="{{ route('showbinangkit.update', $showbinangkit->id) }}" method="POST">
                        @method('put')
                        @csrf
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="" class="form-label h5">Nama Pengguna</label>
                                <input value="{{ old('nama_pengguna', $showbinangkit->nama_pengguna) }}" type="text"
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{ old('nama_kegiatan', $showbinangkit->nama_kegiatan) }}" type="text"
                            ...
                            <div class="mb-3">
                                ...
                                @php
                                    $tanggalSewa = explode(' - ', $showbinangkit->tanggal_sewa);
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{ old('waktu_penggunaan', $showbinangkit->waktu_penggunaan) }}"
                                    type="text"

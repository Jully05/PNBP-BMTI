...
@section('title', 'Admin | Tambah Booking WISMA WASKITA')

@section('content')

    <div class="bg-primary py-3">
        <h3 class="text-white text-center">BOOKING GEDUNG WISMA WASKITA</h3>
    </div>

    <div class="bg-red-200">
        <div class="row justify-content-center mt-4">
            <div class="col-md-10 d-flex justify-content-end">
                <a href="{{ route('showwaskita.index') }}" class="btn btn-primary">index Booking </a>
            </div>
        </div>
        <div class="row d-flex justify-content-center">
            <div class="col-md-10">
                <div class="card border-0 shadow-lg my-4">
                    ...
                    <form action="{{ route('showwaskita.index') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            <div class="mb-3">

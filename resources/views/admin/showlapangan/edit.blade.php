...
@section('title', 'Admin | Edit Booking LAPANGAN BOLA')

@section('content')
    <div class="bg-primary py-3">
        <h3 class="text-white text-center">EDIT BOOKING GEDUNG LAPANGAN BOLA</h3>
    </div>

    <div class="container">
        <div class="row justify-content-center mt-4">
            <div class="col-md-10 d-flex justify-content-end">
                <a href="{{ route('showlapangan.index') }}" class="btn btn-primary">List Booking</a>
            </div>
        </div>
        ...
        <div class="row d-flex justify-content-center">
            <div class="col-md-10">
                <div class="card border-0 shadow-lg my-4">
                    ...
                    <form action="{{ route('showlapangan.update', $showlapangan->id) }}" method="POST">
                        @method('put')
                        @csrf
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="" class="form-label h5">Nama Pengguna</label>
                                <input value="{{ old('nama_pengguna', $showlapangan->nama_pengguna) }}" type="text"
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{ old('nama_kegiatan', $showlapangan->nama_kegiatan) }}" type="text"
                            ...
                            <div class="mb-3">
                                ...
                                @php
                                    $tanggalSewa = explode(' - ', $showlapangan->tanggal_sewa);
                            ...
                            <div class="mb-3">
                                ...
                                <input value="{{ old('waktu_penggunaan', $showlapangan->waktu_penggunaan) }}"
                                    type="text"

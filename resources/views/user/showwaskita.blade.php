...
@section('title', 'User | List Booking wisma Waskita')
...
@section('content')
        ...
        <main class="w-full">
            ...
            <div class="w-full flex flex-col md:flex-row md:px-10 justify-center gap-6 ">
                ...
                <div class="w-full md:w-3/5 bg-gradient-to-r from-white-500 to-indigo-500 p-6 rounded-lg md:shadow-lg">
                    <p class="md:text-2xl font-bold pb-5">Galeri Wisma Waskita</p>
                    <div class="w-2xl">
                        <img id="mainImage" src="/img/wisma waskita/ww (107).jpg" alt="Foto Gedung"
                    ...
                    <div class="relative w-full mt-6 overflow-hidden">
                        ...
                        <div id="smallImages"
                            ...
                            <img src="/img/wisma waskita/ww (107).jpg" alt="Foto 1"
                                class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300"
                                data-src="/img/wisma waskita/ww (107).jpg">
                            <img src="/img/wisma waskita/ww (1).jpg" alt="Foto 1"
                                class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300"
                                data-src="/img/wisma waskita/ww (1).jpg">
                            <img src="/img/wisma waskita/ww (24).jpg" alt="Foto 1"
                                class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300"
                                data-src="/img/wisma waskita/ww (24).jpg">
                            <img src="/img/wisma waskita/ww (23).jpg" alt="Foto 1"
                                class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300"
                                data-src="/img/wisma waskita/ww (23).jpg">
                            <img src="/img/wisma waskita/ww (43).jpg" alt="Foto 1"
                                class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300"
                                data-src="/img/wisma waskita/ww (43).jpg">
                            <img src="/img/wisma waskita/ww (9).jpg" alt="Foto 1"
                                class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300"
                                data-src="/img/wisma waskita/ww (9).jpg">
                            <img src="/img/wisma waskita/ww (25).jpg" alt="Foto 1"
                                class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300"
                                data-src="/img/wisma waskita/ww (25).jpg">
                            <img src="/img/wisma waskita/ww (26).jpg" alt="Foto 1"
                                class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300"
                                data-src="/img/wisma waskita/ww (26).jpg">
                            <img src="/img/wisma waskita/ww (34).jpg" alt="Foto 1"
                                class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300"
                                data-src="/img/wisma waskita/ww (34).jpg">
                            <img src="/img/wisma waskita/ww (4).jpg" alt="Foto 1"
                                class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300"
                                data-src="/img/wisma waskita/ww (4).jpg">
                            <img src="/img/wisma waskita/ww (15).jpg" alt="Foto 1"
                                class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300"
                                data-src="/img/wisma waskita/ww (15).jpg">
                            <img src="/img/wisma waskita/ww (31).jpg" alt="Foto 1"
                                class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300"
                                data-src="/img/wisma waskita/ww (31).jpg">
                            <img src="/img/wisma waskita/ww (66).jpg" alt="Foto 1"
                                class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300"
                                data-src="/img/wisma waskita/ww (66).jpg">
                            <img src="/img/wisma waskita/ww (73).jpg" alt="Foto 1"
                                class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300"
                                data-src="/img/wisma waskita/ww (73).jpg">
                            <img src="/img/wisma waskita/ww (86).jpg" alt="Foto 1"
                                class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300"
                                data-src="/img/wisma waskita/ww (86).jpg">
                            <img src="/img/wisma waskita/ww (92).jpg" alt="Foto 1"
                                class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300"
                                data-src="/img/wisma waskita/ww (92).jpg">
                            <img src="/img/wisma waskita/ww (106).jpg" alt="Foto 1"
                                class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300"
                                data-src="/img/wisma waskita/ww (106).jpg">
                            <img src="/img/wisma waskita/ww (52).jpg" alt="Foto 1"
                                class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300"
                                data-src="/img/wisma waskita/ww (52).jpg">
                            <img src="/img/wisma waskita/ww (49).jpg" alt="Foto 1"
                                class="w-24 h-24 rounded-21 cursor-pointer hover:scale-105 transition-transform duration-300"
                                data-src="/img/wisma waskita/ww (49).jpg">
                        </div>
                        <!-- Tombol Scroll Kanan -->
                ...
                <div class="w-full md:w-2/5 md:shadow-lg rounded-lg p-6">
                    <h2 class="md:text-2xl font-bold pb-5">Jadwal Wisma Waskita</h2>
                    <div id='calendarwaskita' class="w-full md:h-5/6 h-80 bg-gray-200 p-3 rounded-lg"></div>
                </div>
            ...
            <div class=" md:px-10 flex flex-col md:flex-row justify-between md:gap-6">
                ...
                <div
                    ...
                    <div class="md:w-4/5">
                        <p class="text-xl font-bold ">Deskripsi Wisma Waskita</p>
                    ...
                    <div class="md:w-2/5">
                        ...
                        <table
                            ...
                            <tr>
                                <td><i class="fas fa-utensils fa-sm text-blue-500 mr-5 px-3 w-4 h-4"></i>
                                </td>
                                <td>Kantin</td>
                                <td>: 2 Tempat</td>
                            </tr>
                            <tr>
                                ...
                                <td>Kamar mandi di luar</td>
                                <td>: 27</td>
                            </tr>
                            <tr>
                                <td><i class="fas fa-bed fa-sm text-blue-500 mr-5 px-3 w-4 h-4"></i></td>
                                <td>Kamar mandi di dalam</td>
                                <td>: 48</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td><i class="fas fa-dumbbell fa-sm text-blue-500 mr-5 px-3 w-4 h-4"></i></td>
                                <td>Tempat Gym</td>
                                <td>: 1</td>
                            </tr>
                            <tr>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var calendarEl = document.getElementById('calendarwaskita');

            var calendar = new FullCalendar.Calendar(calendarEl, {
                initialView: 'dayGridMonth',
                events: @json($calendarBookingsWaskita),
                eventClick: function(info) {
                    var bookingwaskita = info.event.extendedProps;
                    document.getElementById('bookingId').value = info.event.id;
                    document.getElementById('nama_pengguna').value = bookingwaskita.nama_pengguna;
                    document.getElementById('nama_kegiatan').value = info.event.title;
                    document.getElementById('waktu_penggunaan').value = bookingwaskita
                        .waktu_penggunaan;

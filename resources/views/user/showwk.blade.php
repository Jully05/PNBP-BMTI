...
@section('title', 'Admin | List Booking wisma kangguru')
                ...
                <div class="w-full md:w-3/5 bg-gradient-to-r from-white-500 to-indigo-500 p-6 rounded-lg md:shadow-lg">
                    ...
                    <div class="relative w-full mt-6 overflow-hidden">
                        ...
                        <div id="smallImages"
                            ...
                            <img src="/img/wisma kangguru/wk (1).jpg" alt="Foto 1" class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300" data-src="/img/wisma kangguru/wk (1).jpg">
                            <img src="/img/wisma kangguru/wk (2).jpg" alt="Foto 1" class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300" data-src="/img/wisma kangguru/wk (2).jpg">
                            <img src="/img/wisma kangguru/wk (3).jpg" alt="Foto 1" class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300" data-src="/img/wisma kangguru/wk (3).jpg">
                            <img src="/img/wisma kangguru/wk (4).jpg" alt="Foto 1" class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300" data-src="/img/wisma kangguru/wk (4).jpg">
                            <img src="/img/wisma kangguru/wk (5).jpg" alt="Foto 1" class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300" data-src="/img/wisma kangguru/wk (5).jpg">
                            <img src="/img/wisma kangguru/wk (6).jpg" alt="Foto 1" class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300" data-src="/img/wisma kangguru/wk (6).jpg">
                            <img src="/img/wisma kangguru/wk (7).jpg" alt="Foto 1" class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300" data-src="/img/wisma kangguru/wk (7).jpg">
                            <img src="/img/wisma kangguru/wk (8).jpg" alt="Foto 1" class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300" data-src="/img/wisma kangguru/wk (8).jpg">
                            <img src="/img/wisma kangguru/wk (9).jpg" alt="Foto 1" class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300" data-src="/img/wisma kangguru/wk (9).jpg">
                            <img src="/img/wisma kangguru/wk (10).jpg" alt="Foto 1" class="w-24 h-24 rounded-lg cursor-pointer hover:scale-105 transition-transform duration-300" data-src="/img/wisma kangguru/wk (10).jpg">
                        </div>
                        <!-- Tombol Scroll Kanan -->
